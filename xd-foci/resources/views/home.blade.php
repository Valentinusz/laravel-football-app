<x-app-layout>
    ...
    <h3 class='text-center pt-20 pb-28 text-5xl'>Merülj el a labdarúgás világában!</h3>
    <div class='flex gap-8 justify-between mx-8'>
        ...
        <x-home-link label='Csapatok' icon='group' :resource=' route("games.index") '></x-home-link>
